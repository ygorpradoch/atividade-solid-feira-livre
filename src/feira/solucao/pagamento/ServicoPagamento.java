...
public class ServicoPagamento {
    private final Map<String, ProcessadorPagamento> processadoresPorCodigo = new HashMap<>();
    ...
    public void pagar(String codigoPagamento, double valor) {
        if (codigoPagamento == null) throw new IllegalArgumentException("Forma de pagamento é obrigatória");
        
        ProcessadorPagamento processador = processadoresPorCodigo.get(codigoPagamento.toUpperCase());
        if (processador == null) throw new IllegalArgumentException("Pagamento não suportado: " + codigoPagamento);
